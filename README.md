...
Windows 本地桌面 Demo，用普通摄像头或本地录像进行动作观察、评估记录和已确认计划的训练提示。当前 **0.14.0** 支持正面＋侧面双摄，增加逐步准备引导和专业术语与通俗解释并列的结果报告；保留身体部位导航、53 项任务、个人档案、评估清单、个人训练计划、组次与逐动作时间、按条件核对的纵向历史。
