...
Windows 本地桌面 Demo，用普通摄像头或本地录像进行动作观察、评估记录和已确认计划的训练提示。当前 **0.15.0 融合版** 将逐步准备引导、可取消的倒计时记录、一次最终人工核对、提示降噪与专业术语 / 通俗解释并列的结果报告接成完整流程；保留正面＋侧面双摄的逐项有效性、身体部位导航、53 项任务、个人档案、评估清单、个人训练计划、组次与逐动作时间、按条件核对的纵向历史。
