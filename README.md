...
Windows 本地桌面 Demo，用普通摄像头或本地录像进行动作观察、评估记录和已确认计划的训练提示。当前 **0.16.0 银发增量版** 在 0.15 融合流程上增加活动任务闭环、固定参考变化卡、本机家庭回应、人工环境整改及隔离手机联动演示；保留逐步准备、提示降噪、双摄逐项有效性与结果解读。未新增模型，不宣称全屋监护或正式远程救援。
