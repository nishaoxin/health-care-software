...
当前应用为 **0.16.0 银发增量版**，保留 0.15 融合流程，新增活动闭环、固定参考变化卡、本机家庭回应与隔离手机演示。使用和继续开发先读下面的入口文档；带版本号的旧文档用于追溯。

| 文档 | 内容 |
| --- | --- |
| [银发健康守护说明](history/SILVER_HEALTH_V0_16.md) | 计划映射、使用步骤、算法来源、双摄与家庭协同边界 |
| [银发增量本机验收](validation/SILVER_HEALTH_V0_16_2026-09-12.md) | 实际回归、桌面截图、回环浏览器闭环与未验收项 |
| [使用指南](USER_GUIDE.md) | 启动、相机测试、评估、训练、报告和常见问题 |
| [当前交接与待办](HANDOFF.md) | 实际功能、未完成目标、下一步所需条件 |
| [开发说明](DEVELOPMENT.md) | 环境、代码结构、测试和提交方式 |
| [本次整理与验收](validation/INTEGRATION_2026-09-10.md) | 压缩包来源、提交关系、目录变更、本机实际结果 |
...
历史测试输出中的 109 项是 2026-09-06 的首版结果；同学最后记录的 1089 项是当时选择的批次。最新本机结果只看本次验收，不能把这些数字相加。
